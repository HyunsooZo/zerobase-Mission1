...
<%@ page import="com.example.wifiaroundme.GroupDBTable" %>
<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
<%
    String selectedRow = request.getParameter("wifiID");
    ArrayList<String> detailed = new ArrayList<>();
    WifiApi wifi = new WifiApi();

    for (ArrayList<String> list : wifi.callApi()) {
        if (list.get(1).equals(selectedRow)) {
            detailed = new ArrayList<>(list);
            break;
        }
    }
    GroupDBTable groupTB = new GroupDBTable();
...
<body>
    ...
    <div class="table-top">
        ...
        <span>
            <button type="button" onclick="addBookMark()">북마크 추가하기</button>
        </span>
    </div>
    <table>
        <colgroup>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href=wifi-detail.jsp?wifiID=<%=selectedRow%>><%=detailed.get(3).replace("\"", "")%></a>
                </td>
            </tr>
            <tr>
